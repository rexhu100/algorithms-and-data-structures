...
public class Point implements Comparable<Point> {
    ...
    static private class slopeComparator implements Comparator<Point> {
        ...
        public int compare(Point o1, Point o2) {
            double s1 = origin.slopeTo(o1);
            double s2 = origin.slopeTo(o2);
    ...
    public int compareTo(Point that) {
        /* YOUR CODE HERE */
        return that.y==this.y?Integer.compare(this.x, that.x):Integer.compare(this.y, that.y);
    }
